...
do
	local list = require("quests_vanilla.quests")
	local data = require("quests_vanilla.enUS.quests")
	exportToFiles(list, data)
end

-- Export Turtle Quests
do
	local list = require("quests_turtle.quests-turtle")
	local data = require("quests_turtle.enUS.quests-turtle")
	exportToFiles(list, data)
end
